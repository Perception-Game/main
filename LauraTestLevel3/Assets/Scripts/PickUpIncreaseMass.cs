 ...
 */
public class PickUpIncreaseMass : MonoBehaviour
{
	...
	void Pickup()
	{
		if (Input.GetKeyDown(KeyCode.E))
		{
			...
			{
				DecreaseMassPickupable p = hit.collider.GetComponent<DecreaseMassPickupable>();
				if (p != null)
				{
					//change mass to stop objects from moving on collision
