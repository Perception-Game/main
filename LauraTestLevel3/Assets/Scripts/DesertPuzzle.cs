 ...
 * If they are, the metal bars will disapear, sound will play, and the player
...
public class DesertPuzzle : MonoBehaviour {
    ...
    public AudioSource sound; //winning sound effect
    ...
    void Start () {
        ...
        sound = GetComponent<AudioSource>(); //find sound
    }
